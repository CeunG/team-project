      ...
      <div className='grid-wrap'>
                ...
                <li>
                  <div className='in-list'>
                    ...
                    <div className='btn-area'>
                      <Button
                        className='in-follow-btn'
                        variant='contained'
                        size='small'
                        sx={{ ml: 1, flex: 1, borderRadius: " 500px", fontSize: "13px" }}
                      >
                        Follow
                      </Button>
                    </div>
          ...
          <div className='record-info-box'>
            ...
            <div className='info-box-txt'>
              ...
              <ul className='count-list'>
                <li>
                  올린 피드<span class='point-tit'>1개</span>
                </li>
                <li>
                  나의 목표 지금까지<span class='point-tit'>6개</span>
                </li>
              </ul>
            </div>
            ...
            <div className='btn-graph'>
              <Button
                className='btn-graph-link'
                variant='contained'
                endIcon={<SettingsAccessibilityOutlinedIcon />}
                sx={{
        ...
        <section className='sec-right radius-25'>
          <div className='record-forms'>
            <div className='sec-calendar'>달력 넣기(라이브러리)</div>
                      ...
                      <ul className='goal-list chkform-list'>
                        <li>
                          ...
                          <IconButton
                            aria-label='delete'
                            size='small'
                            sx={{ color: "secondary.light", border: "1px solid gray" }}
                            className='btn-delte'
                          >
