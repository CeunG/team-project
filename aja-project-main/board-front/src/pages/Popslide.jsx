...
import Buttons from "../components/jsx_styles/Buttons";
  ...
  return (
    <div id='pop-slide'>
      <div className='pop-slide-mates '>
        ...
        <ul className='record-list-mini'>
          <li>
            ...
            <Buttons size='small' className='in-unfllow-btn'>
              unfollow
            </Buttons>
          </li>
      ...
      <div className='pop-slide-recomm'>
        ...
        <Buttons size='small' className='in-fllow-btn'>
          팔로우
        </Buttons>
        <Buttons size='small' className='in-message-btn'>
          메세지
        </Buttons>
      </div>
    </div>
